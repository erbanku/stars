...
- [mayankjain0141/nixis](https://github.com/mayankjain0141/nixis) - Real-time governance engine for AI coding agents. Intercepts every tool call (file writes, shell commands, network access) and evaluates it against security policies in <200ms. CEL policy engine, information flow control, secret scanning, delegation chains, tamper-evident audit, and a real-time dashboard.
